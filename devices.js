...
const waveshare2in13Horizontal = {
	height: 122,
	width: 250,
	driver: waveshare2in13Driver,
	displayPNG: async function (imgContents) {
		const buffer = await image.convertPNGto1BitBW(imgContents);
		this.driver.display(buffer);
	},
...
const devices = {
	...
	// default waveshare7in5v2 kept for backwards compatibility with release 1.1.0
	waveshare7in5v2: waveshare7in5v2Horizontal,
	waveshare7in5v2Horizontal,
	waveshare7in5v2Vertical,
	// default waveshare2in13v2 kept for backwards compatibility with release 1.1.0
	waveshare2in13v2: waveshare2in13v2Horizontal,
	waveshare2in13v2Horizontal,
	waveshare2in13v2Vertical,
	// default waveshare2in13 kept for backwards compatibility with release 1.1.0
	waveshare2in13: waveshare2in13Horizontal,
	waveshare2in13Horizontal,
	waveshare2in13Vertical,
};
